    ...
    $containerBuilder->addDefinitions([
        'settings' => [
            ...
            'mail' => [
                ...
                'from_address' => $_ENV['MAIL_FROM_ADDRESS'] ?? 'info@indowater.example.com',
                'from_name' => $_ENV['MAIL_FROM_NAME'] ?? 'IndoWater',
            ],
            'midtrans' => [
                ...
                'finish_url' => $_ENV['MIDTRANS_FINISH_URL'] ?? '',
                'unfinish_url' => $_ENV['MIDTRANS_UNFINISH_URL'] ?? '',
                'error_url' => $_ENV['MIDTRANS_ERROR_URL'] ?? '',
            ],
            'doku' => [
                'client_id' => $_ENV['DOKU_CLIENT_ID'] ?? '',
                'secret' => $_ENV['DOKU_SECRET'] ?? '',
                'private_key' => $_ENV['DOKU_PRIVATE_KEY'] ?? '',
                'public_key' => $_ENV['DOKU_PUBLIC_KEY'] ?? '',
                'is_production' => filter_var($_ENV['DOKU_IS_PRODUCTION'] ?? false, FILTER_VALIDATE_BOOLEAN),
                'callback_url' => $_ENV['DOKU_CALLBACK_URL'] ?? '',
                'redirect_url' => $_ENV['DOKU_REDIRECT_URL'] ?? '',
            ],
            'whatsapp' => [
